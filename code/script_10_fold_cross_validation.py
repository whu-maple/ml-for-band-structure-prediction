...
def main(config_json_file, fold):
    ...
    trainset_rawdata_path = f'../data/data set/10-fold cross-validation/Fold{fold}/raw/training/'
    trainset_dgldata_path = f'../data/data set/10-fold cross-validation/Fold{fold}/dgl/training/'
    ...
    torch.save({
            ...
            'loss': loss,
            }, f'./results/10-fold cross-validation/Fold{fold}.pkl')

if __name__ == '__main__':
    main(config_json_file = "./script_10_fold_cross_validation_config.json", fold = 10)
