...
def main(config_json_file, fold):
    ...
    trainset_rawdata_path = f'../data/data set/few-shot/Fold{fold}/raw/training/'
    trainset_dgldata_path = f'../data/data set/few-shot/Fold{fold}/dgl/training/'
    ...
    for epoch in range(1,num_epoch + 1):
        ...
        print("Epoch {:05d} | TrainSet_Loss {:.6f}" . format(epoch, loss.item()))
    ...
    torch.save({
            ...
            'loss': loss,
            }, f'./results/few-shot/Fold{fold}.pkl')

if __name__ == '__main__':
    main(config_json_file = "./script_few_shot_config.json", fold = 10)
