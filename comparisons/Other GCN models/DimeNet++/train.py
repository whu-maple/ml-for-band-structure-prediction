...
from dataset import GGCNNDATASET
...
def main(config_json_file, fold):
    ...
    trainset_rawdata_path = f'./Fold{fold}/raw/training/'
    trainset_dgldata_path = f'./Fold{fold}/dgl/training/'
    
    # configure network structure
    gnn_emb_size           = config_para["gnn_emb_size"]
    gnn_out_emb_size       = config_para["gnn_out_emb_size"]
    gnn_int_emb_size       = config_para["gnn_int_emb_size"]
    gnn_basis_emb_size     = config_para["gnn_basis_emb_size"]
    gnn_num_blocks         = config_para["gnn_num_blocks"]
    gnn_num_spherical      = config_para["gnn_num_spherical"]
    gnn_num_radial         = config_para["gnn_num_radial"]
    ...
    model = WHOLEMODEL(
                        gnn_emb_size = gnn_emb_size,
                        gnn_out_emb_size = gnn_out_emb_size,
                        gnn_int_emb_size = gnn_int_emb_size,
                        gnn_basis_emb_size = gnn_basis_emb_size,
                        gnn_num_blocks = gnn_num_blocks,
                        gnn_num_spherical = gnn_num_spherical,
                        gnn_num_radial = gnn_num_radial,
...
if __name__ == '__main__':
    main(config_json_file = "./train_config.json", fold = 10)
